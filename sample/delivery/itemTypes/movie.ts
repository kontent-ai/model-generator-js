...
import type { ReleaseCategoryTaxonomyTermCodenames } from '../taxonomies/index.js';
...
export type Movie = CoreItem<
	MovieElementCodenames,
	{
		 ...
		 */
		readonly releasecategory: Elements.TaxonomyElement<ReleaseCategoryTaxonomyTermCodenames, 'releasecategory'>;
	},
	'movie'
>;
 ...
 * Codename: movie
 */
export function isMovie(item: CoreItem | undefined | null): item is Movie {
