...
* Codename: snippet_a__linked_items_with_specific_types
*/
export function isLinkedItemsWithSpecificTypesElementCodename(value: string | undefined | null): value is LinkedItemsWithSpecificTypesElementCodename {
                return typeof value === 'string' && value === ('snippet_a__linked_items_with_specific_types' satisfies LinkedItemsWithSpecificTypesElementCodename);
            }
