...
*/
export type TypeWithEmptySnippet = CoreItem<
TypeWithEmptySnippetElementCodenames,
Record<string, never>, 
...
* Codename: type_with_empty_snippet
*/
export function isTypeWithEmptySnippetItem(item: CoreItem | undefined | null): item is TypeWithEmptySnippet {
