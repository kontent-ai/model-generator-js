...
import type { ContentTypeCodenames } from './_contentTypes.js';
 ...
 /**
 * Type representing codename of Circular reference type A > B ContentType
 * 
...
* Codename: circular_reference_type_a_b
*/
export function isCircularReferenceTypeABContentTypeCodename(value: string | undefined | null): value is CircularReferenceTypeABContentTypeCodename {
