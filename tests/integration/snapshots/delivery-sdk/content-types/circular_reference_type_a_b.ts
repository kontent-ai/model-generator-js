...
import type { CircularReferenceTypeBA } from './index.js';
 ...
 */
export type CircularReferenceTypeAB = CoreContentType<
 ...
 * Codename: circular_reference_type_a_b
 */
export function isCircularReferenceTypeAB(item: CoreContentType | undefined | null): item is CircularReferenceTypeAB {
