 ...
 */
export type EmptyContentType = CoreContentType<EmptyContentTypeElementCodenames, Record<string, never>, 'empty_content_type'>;
 ...
 * Codename: empty_content_type
 */
export function isEmptyContentType(item: CoreContentType | undefined | null): item is EmptyContentType {
