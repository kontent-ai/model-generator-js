...
import type { SnippetA } from '../content-type-snippets/index.ts';
import type { TaxonomyA } from '../taxonomies/index.ts';
 ...
 */
export type ContentTypeWithAllElements = CoreContentType<
    ContentTypeWithAllElementsElementCodenames,
    {
         ...
         */
        readonly taxonomy_element: Elements.TaxonomyElement<TaxonomyA, 'taxonomy_element'>;
    } & SnippetA,
 ...
 * Codename: content_type_with_all_elements
 */
export function isContentTypeWithAllElements(item: CoreContentType | undefined | null): item is ContentTypeWithAllElements {
