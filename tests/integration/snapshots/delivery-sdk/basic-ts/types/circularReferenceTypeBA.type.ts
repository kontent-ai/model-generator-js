...
import type { CircularReferenceTypeABType } from './index.ts';
 ...
 * Codename: circular_reference_type_b____a
 */
export function isCircularReferenceTypeBA(item: CoreType | undefined | null): item is CircularReferenceTypeBAType {
