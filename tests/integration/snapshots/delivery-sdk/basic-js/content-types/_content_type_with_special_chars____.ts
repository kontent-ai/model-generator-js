 ...
 */
export type ContentTypeWithSpecialChars = CoreContentType<
 ...
 * Codename: _content_type_with_special_chars____
 */
export function isContentTypeWithSpecialChars(item: CoreContentType | undefined | null): item is ContentTypeWithSpecialChars {
