 ...
 */
export type ContentTypeTypeReferencingDeletedTypeType = CoreType<
	ContentTypeTypeReferencingDeletedTypeTypeElementCodenames,
	{
		/*
	...
	ContentTypeTypeReferencingDeletedTypeTypeCodename
>;

/*
 * Type representing all available element codenames for Type referencing deleted type
 */
export type ContentTypeTypeReferencingDeletedTypeTypeElementCodenames = 'rich_text_with_invalid_type' | 'linked_items_with_invalid_type';
