 ...
 * Codename: content_type_with_all_elements
 */
export type ContentTypeContentTypeWithAllElementsType = CoreType<
	ContentTypeContentTypeWithAllElementsTypeElementCodenames,
	{
		/*
		 * Text element
		 *
		 ...
		 */
		readonly linked_items_element: Elements.LinkedItemsElement<ContentTypeContentTypeWithAllElementsType>;
		/*
		 * Asset element
		 *
		 * Type: asset
		 ...
		 */
		readonly multiple_choice_element: Elements.MultipleChoiceElement<ContentTypeContentTypeWithAllElementsTypeMultipleChoiceElementMultipleChoiceOptions>;
		/*
		 * Number element
		 *
		 * Type: number
 ...
 */
export type ContentTypeContentTypeWithAllElementsTypeElementCodenames =
	| 'text_element'
	| 'url_slug_element'
	| 'rich_text_element'
	| 'date___time_element'
...
export type ContentTypeContentTypeWithAllElementsTypeMultipleChoiceElementMultipleChoiceOptions = 'option_a' | 'option_b';
