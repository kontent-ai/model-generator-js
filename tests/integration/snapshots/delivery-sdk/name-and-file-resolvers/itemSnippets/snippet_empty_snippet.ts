 ...
 */
export type Snippet_empty_snippet = Snippet<Snippet_empty_snippetElementCodenames, Record<string, never>>;

/*
 * Type representing all available element codenames for Empty snippet
 */
export type Snippet_empty_snippetElementCodenames = never;
