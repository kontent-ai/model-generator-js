...
import type { Snippet_snippet_a } from '../itemSnippets/index.js';
import type { Taxonomy_taxonomy_aTaxonomyTermCodenames } from '../taxonomies/index.js';
 ...
 */
export type ContentType_content_type_with_all_elements = CoreItem<
	ContentType_content_type_with_all_elementsElementCodenames,
	{
		/*
		 * Text element
		 *
		 ...
		 */
		readonly linked_items_element: Elements.LinkedItemsElement<ContentType_content_type_with_all_elements>;
		/*
		 * Asset element
		 *
		 * Type: asset
		 ...
		 */
		readonly taxonomy_element: Elements.TaxonomyElement<Taxonomy_taxonomy_aTaxonomyTermCodenames, 'taxonomy_element'>;
	} & Snippet_snippet_a,
 ...
 */
export type ContentType_content_type_with_all_elementsElementCodenames =
	| 'text_element'
	| 'url_slug_element'
	| 'rich_text_element'
	| 'date___time_element'
 ...
 * Codename: content_type_with_all_elements
 */
export function isContentType_content_type_with_all_elements(
