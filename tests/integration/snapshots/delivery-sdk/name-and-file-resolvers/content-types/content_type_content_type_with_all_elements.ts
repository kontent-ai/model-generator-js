...
import type { Taxonomy_taxonomy_a } from '../taxonomies/index.js';
 ...
 */
export type ContentType_content_type_with_all_elements = CoreContentType<
    ContentType_content_type_with_all_elementsElementCodenames,
    {
         ...
         */
        readonly rich_text_element: Elements.RichTextElement<CoreContentType>;
        /**
         * Date & time element
         *
         * Type: date_time
         ...
         */
        readonly taxonomy_element: Elements.TaxonomyElement<Taxonomy_taxonomy_a, 'taxonomy_element'>;
    } & Snippet_snippet_a,
