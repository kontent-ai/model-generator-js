 ...
 */
export type ContentType_web_spotlight_root = CoreContentType<
 ...
 * Codename: web_spotlight_root
 */
export function isContentType_web_spotlight_root(item: CoreContentType | undefined | null): item is ContentType_web_spotlight_root {
