...
## [9.0.0-5](https://github.com/kontent-ai/model-generator-js/compare/v9.0.0-4...v9.0.0-5) (2025-05-16)


### Features

* change name/file resolvers to not include entity type name if custom function is provided ([065d730](https://github.com/kontent-ai/model-generator-js/commit/065d730c1a44304a30b5a35805359e9418131c4b))

## [9.0.0-4](https://github.com/kontent-ai/model-generator-js/compare/v9.0.0-3...v9.0.0-4) (2025-05-16)

### Features

* Extracts multiple choice option values into type ([81efa75](https://github.com/kontent-ai/model-generator-js/commit/81efa75c75f19259c3fce717d971d90e86896b9a))
* Renames `CoreItem` to `CoreType`.
* By default all types based on `CoreType` are suffixed with `Type`. For example, a content type with name `Movie` will be have `MovieType` type name. This can be overriden with custom `nameResolvers` configuration option which can be used to customize the name of objects.
...
* Adds support for elements placed in content type snippets (fixes <https://github.com/kontent-ai/model-generator-js/issues/24>)
